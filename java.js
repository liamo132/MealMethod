window.addEventListener("scroll", function() {
    ...
    var scaleFactor = 1 - window.scrollY / 1000; // Adjust the divisor as needed

    // Ensure the scale factor stays within a reasonable range
    scaleFactor = Math.max(0.9, scaleFactor); // Minimum scale: 0.9
...
// Add scroll event listener to trigger showing carousel slides
